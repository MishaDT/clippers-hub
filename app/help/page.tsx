...
const questions = [
  ["Как взять заказ?", "Откройте раздел заказов, выберите подходящее задание и нажмите «Взять заказ». До подтверждения вы увидите чистую выплату, дедлайн и условия."],
