      ...
      <main className={styles.page}>
        ...
        <section className={styles.rule}>
          ...
          <ol>
            ...
            <li><b>Нет блокирующей аномалии.</b> При fraud-score 70% и выше работа не переходит к выплате и требует ручной проверки. Автоматический score показывает риск, но сам по себе не считается доказательством накрутки.</li>
