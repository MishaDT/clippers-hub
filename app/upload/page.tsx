    ...
    <AppShell>
      <section className="section up-screen">
        <div className="up-head">
          ...
          <p>Опубликуй ролик с кодом заказа в описании и вставь ссылку — мы подтвердим, что клип твой, начнём считать просмотры и начислим выплату после проверки. Текущий статус всегда виден в рабочей зоне и уведомлениях.</p>
        </div>
