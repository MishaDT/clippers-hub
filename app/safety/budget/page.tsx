...
const cards = [
  ...
  [BadgeCheck, "Платим после проверок", "Нужны цель по просмотрам, подтверждённая связь публикации с исполнителем и fraud-score ниже блокирующего порога."],
      ...
      <main className={styles.page}>
        ...
        <section className={styles.rule}>
          ...
          <ol>
            ...
            <li><b>Достигнута цель.</b> Число просмотров не ниже цели кампании.</li>
